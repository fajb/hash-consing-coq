...
Module N <: OrderedTypeAlt.
  ...
  #[export] Hint Resolve expr_compare_trans expr_compare_sym : core.
...
#[export] Hint Constructors wf_expr : core.

Lemma wf_expr_lt:
  forall b v v' e, wf_expr b v e -> (v < v')%positive -> wf_expr b v' e.
Proof.
  destruct 1; econstructor. eauto. lia.
Qed.
...
#[export] Hint Resolve <- wf_bijection : core.
#[export] Hint Resolve -> wf_bijection : core.
#[export] Hint Resolve wf_map_wf_expr_h wf_map_wf_expr_l wf_expr_lt_next : core.
...
#[export] Hint Resolve wbo_wf : core.
...
#[export] Hint Resolve wbo_incr : core.
...
Proof.
  ...
  econstructor; eauto.
Qed.
#[export] Hint Resolve value_incr : core.
...
#[export] Hint Resolve value_rcni : core.
...
Proof.
  ...
  { constructor. simpl. lia.
    ...
    destruct x as [[l' v'] h']. apply wf_expr_lt_next with (v:=Pos.succ v'). auto.
  ...
  { constructor; simpl.
    - intros p n.
      ...
      + rewrite wf_bijection by auto.
        ...
        * split. intro.
          assert (p < next st)%positive.
          destruct n as [[l' v'] h']. apply wf_expr_lt_next with (v:=Pos.succ v'). auto.
          econstructor. eauto. lia.
          exfalso. lia.
          congruence.
        * tauto.
...
Section t.
  Section operations.
    ...
    Section combinator.
      ...
      Qed.
      Hint Resolve combinator_sem_eauto : core.
    ...
    Section mk_not.
      ...
      Hint Resolve negb_sem_eauto : core.
...
Proof.
  ...
  + destruct Ha; inversion Hval; econstructor; rewrite H0 in H3; inject H3; eauto.
    ...
    apply -> H; auto. destruct vv; eauto. lia. auto.
  + destruct Ha; inversion Hval; econstructor; rewrite H0 in H3; inject H3; eauto.
    rewrite PMap.gso in H4; eauto. lia.
    apply <- H; auto. eauto. destruct vv; eauto. lia. auto.
Qed.
